...
Namespace AsyncDataLoading
    Public Class AsynchronousDataLoadingBehavior
        ...
        Public Shared ReadOnly AllowFilterEditorProperty As DependencyProperty = DependencyProperty.Register("AllowFilterEditor", GetType(Boolean), GetType(AsynchronousDataLoadingBehavior), New PropertyMetadata(True, Sub(d, e) CType(d, AsynchronousDataLoadingBehavior).OnAllowFilterEditorChanged()))
        ...
        Public Shared Function GetGroupIndex(ByVal obj As GridColumn) As Integer
            Return CInt((obj.GetValue(GroupIndexProperty)))
        End Function
        ...
        Public Shared Function GetSortIndex(ByVal obj As GridColumn) As Integer
            Return CInt((obj.GetValue(SortIndexProperty)))
        End Function
        ...
        Private Sub OnAllowFilterEditorChanged()
            If Not IsGridEnabled OrElse GridView Is Nothing Then
                Return
            End If
            GridView.AllowFilterEditor = If(AllowFilterEditor, DefaultBoolean.True, DefaultBoolean.False)
        End Sub
        ...
        Private Sub SetIsEnabledGridCore(ByVal isEnabled As Boolean)
            ...
            GridView.AllowFilterEditor = If(isEn, (If(AllowFilterEditor, DefaultBoolean.True, DefaultBoolean.False)), DefaultBoolean.False)
