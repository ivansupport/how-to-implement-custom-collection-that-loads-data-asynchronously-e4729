    ...
    Public Class DataSourceManager
        ...
        Private Sub InitializeCore()
            ...
            If SubmitChanges_RenamedEvent IsNot Nothing Then
                col = createCollectionMethod.Invoke(Nothing, New Object() {
                    New RequestCount(AddressOf OnRequestCount),
                    New RequestData(AddressOf OnRequestData),
                    New SubmitChanges(AddressOf OnSubmitChanges),
                    Settings
                })
            Else
                col = createCollectionMethod.Invoke(Nothing, New Object() {
