...
Namespace AsyncDataLoading
    ...
    Public MustInherit Class DataSourceManagerBase
        ...
        Public Shared ReadOnly SettingsProperty As DependencyProperty = DependencyProperty.Register("Settings", GetType(AsynchronousCollectionSettings), GetType(DataSourceManagerBase), New PropertyMetadata(Sub(d, e) CType(d, DataSourceManagerBase).OnSettingsChanged()))
        Public Shared ReadOnly IsDataSourceInitializedProperty As DependencyProperty = DependencyProperty.Register("IsDataSourceInitialized", GetType(Boolean), GetType(DataSourceManagerBase), New PropertyMetadata(False, Sub(d, e) CType(d, DataSourceManagerBase).OnIsDataSourceInitializedChanged()))
        Public Property Settings() As AsynchronousCollectionSettings
            Get
                Return DirectCast(GetValue(SettingsProperty), AsynchronousCollectionSettings)
            End Get
        ...
        Public Property IsDataSourceInitialized() As Boolean
            Get
                Return DirectCast(GetValue(IsDataSourceInitializedProperty), Boolean)
            End Get
        ...
        Private Sub OnDataSourceOnLoadingCompleted(ByVal sender As Object, ByVal e As EventArgs)
            RaiseEvent LoadingCompleted(Me, DirectCast(sender, AsynchronousCollectionBase))
        End Sub
        ...
        Private Custom Event PropertyChanged As PropertyChangedEventHandler Implements INotifyPropertyChanged.PropertyChanged
            AddHandler(ByVal value As PropertyChangedEventHandler)
                AddHandler propertyChanged, value
            End AddHandler
            RemoveHandler(ByVal value As PropertyChangedEventHandler)
                RemoveHandler propertyChanged, value
            End RemoveHandler
