...
Namespace WcfService
	...
	Public Class OrderService
        ...
        Private NorthwindEntities As New NorthwindEntities2()
		...
		Public Function GetRecords(ByVal skipCount As Integer, ByVal takeCount As Integer) As IList(Of Order) Implements IOrderService.GetRecords
            Dim res As IEnumerable(Of Order) = _
                From em In NorthwindEntities.Orders.OrderBy(Function(ord) ord.OrderID).Skip(skipCount).Take(takeCount) _
                Select em
            Return res.ToList()
		End Function
